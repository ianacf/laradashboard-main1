    ...
    public function inputData(Request $request): JsonResponse
    {
        try {
            $validator = Validator::make($request->all(), [
                ...
                'value1' => 'sometimes|numeric',
                'value2' => 'sometimes|numeric',
                'value3' => 'sometimes|numeric',
    ...
    public function inputBulk(Request $request): JsonResponse
    {
        try {
            $validator = Validator::make($request->all(), [
                ...
                'data.*.value1' => 'sometimes|numeric',
                'data.*.value2' => 'sometimes|numeric',
                'data.*.value3' => 'sometimes|numeric',
                'api_key' => 'required|string',
            ]);
